...
public class Departments {
    ...
    public static void displayDepartmentMenu(){
        ...
        System.out.println("Please select which function you'd like to perform  " +
                "\n1. Create new department information. \n2. Update existing department information. \n3. Delete department information. \n4. Show a single department's information. \n5. Show all departments information." );
    }
    public static void saveDepartment(String name, String country, String state,String province,int zip,String address, String depManager){
        try {
    ...
    static void updateDepartment(String name, String country, String state,String province,int zip,String address, String depManager, int id){
        try {
            ...
            Statement st = con.createStatement();
            //UPDATE
            boolean update = st.execute("UPDATE department\n" +
                    "SET\n" +
                    "name = '"+name+"',\n" +
                    "country = '"+country+"',\n" +
                    "state = '"+state+"',\n" +
