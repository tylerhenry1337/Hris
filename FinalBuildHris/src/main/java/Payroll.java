...
public class Payroll {
    ...
    static void savePayroll(int empId, String currencyType,double timeClock,double salary,double bonus, int benId,int lId){
        try {
            Connection con = DriverManager.getConnection(url,user,pw );
            Statement st = con.createStatement();
            //CREATE
            boolean inserted = st.execute("insert into payroll(empl_id,currency_type,time_clock,salary,bonus,ben_id,leave_id" + ") VALUES('"+empId+"','"+currencyType+"','"+timeClock+"','"+salary+"','"+bonus+"','"+benId+"','"+lId+"')");
            con.close();
    ...
    static void updatePayroll( String currencyType,double timeClock,double salary,double bonus, int id, int benId,int lId){
        try {
            Connection con = DriverManager.getConnection(url,user,pw);
            Statement st = con.createStatement();
            //UPDATE
